...
<script src="js/core/nprogress.js"></script>
...
<script src="js/plugin/jqplot/jqplot.categoryAxisRenderer.js"></script>
<script src="js/plugin/jqplot/jqplot.canvasAxisLabelRenderer.js"></script>
<script src="js/plugin/masonry.pkgd.js"></script>
<script src="js/plugin/angular-wizard.js"></script>
<script src="js/plugin/lodash.min.js"></script>
<script src="js/plugin/icheck/icheck.min.js"></script>
<script src="js/plugin/nicescroll/jquery.nicescroll.min.js"></script>
<script src="js/plugin/pace/pace.min.js"></script>
<script src="js/plugin/progressbar/bootstrap-progressbar.min.js"></script>
